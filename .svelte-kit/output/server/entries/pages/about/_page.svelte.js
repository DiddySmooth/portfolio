...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-12w9qkt_START -->${$$result.title = `<title>Grayson McClead — About</title>`, ""}<meta name="description" content="Full Stack Developer with 5+ years of experience building scalable web applications with React, Angular, and .NET, based in Austin, TX."><!-- HEAD_svelte-12w9qkt_END -->`, ""} <main> <section class="about-hero" aria-labelledby="about-name" data-svelte-h="svelte-vs7r13"><div class="container"><div class="about-hero-grid"> <div class="portrait-side"><div class="portrait-frame"><img src="/profile.jpg" alt="Grayson McClead" class="portrait-photo"> <div class="portrait-corner-tl" aria-hidden="true"></div> <div class="portrait-corner-bl" aria-hidden="true"></div></div> <div class="portrait-deco" aria-hidden="true"></div> <div class="portrait-deco-2" aria-hidden="true"></div></div>  <div class="bio-side"><div><span class="bio-greeting">Hello, I&#39;m</span> <h1 class="bio-name" id="about-name">Grayson McClead</h1> <p class="bio-role">Full Stack Developer</p></div> <div class="bio-description"><p>I&#39;m a full stack developer with 5+ years of experience building scalable web applications across the
              ...
              conversations.</p></div> <div class="bio-actions"><a href="/contact" class="btn btn-primary">Get In Touch</a> <a href="#" class="btn btn-outline" download aria-label="Download resume (PDF)">Download Resume</a></div></div></div></div></section>  <div class="about-sections"><div class="container"> <section class="timeline-section" aria-labelledby="experience-heading" data-svelte-h="svelte-mb2yf2"><div class="section-header"><span class="section-label">Experience</span> <h2 class="section-title" id="experience-heading">Career Timeline</h2> <div class="section-divider" aria-hidden="true"></div></div> <div class="timeline" role="list"><div class="timeline-item" role="listitem"><div class="timeline-dot" aria-hidden="true"></div> <div class="timeline-period">2021 — Present</div> <h3 class="timeline-role">Full Stack Developer</h3> <p class="timeline-company">Sports Business Journal — Charlotte, NC</p> <p class="timeline-desc">Modernized legacy systems by implementing React and Angular, significantly improving performance and
